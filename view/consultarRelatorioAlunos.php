...
// passa o id e nome para consultar
    $objcc->gerarRelatorioAluno($_POST);
}

#verfica o botão 'consultar' foi acionado
if (isset($_POST["consultaralunos"])) {
    #passa o id e nome para consultar
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jumbotron">                            
                <legend>Relatório dos Alunos 
                    <div align="right">  <a href=relatorios/relatorioAlunos.php>
                        <button type="submit" class="btn btn-primary" id="gerar" style="width: 15%;"> Gerar Relatório </button></a> 
                    </div> <br></legend> 
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        #foreach para listar os dados dos alunos
