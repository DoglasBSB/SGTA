...
if (isset($_POST["inserir"])) {
    #passa o array de dados para inserir o docente
    $objcc->inserirDocente($_POST["dados"]);
}
?>
            ...
            <div class="jumbotron">
                <fieldset>
                    <form method="post"  id="formDocente">
                        <legend>Inserir Docente</legend>
                        <div class="form-group">
                            <div>
                                <label for="nome">Nome</label>
                                <input class="form-control" type="text" name="dados[nome][]" id="nome" required="" placeholder="Digite seu nome" maxlength="150"/>
                            </div>
                            <div>    
                                <label for="cpf">CPF</label>
                                <input id="cpf" class="form-control input-md"  name="dados[cpf][]" type="text"  required="" placeholder="Digite o CPF somente números"  maxlength="14">                   
...
if (isset($_POST["inserir"])) {
    ...
    $docentes = $objcc->consultarDocente(['dados[cpf][]' => $_POST['dados[cpf][]']]);
    $docente = count($docentes);
    if ($docente < 1) {
        $objcc->inserir($_POST);
    } else {
