...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <title>.::Login - SGTA - Recuperar senha::.</title>
...
if (isset($_POST['btnSubmit'])) {
    ...
    $mensagem = "Você esta recebendo este e-mail, por que foi solicitado a alteração de senha para o site NOME_SITE, clique no link abaixo para redefinir sua senha. <br /><a href='http://localhost:122/sgta/redefinirSenha.php?conta={$mailCript}'>Recuperar Senha</a>";
